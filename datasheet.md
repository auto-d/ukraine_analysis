...
Created in support of graduate coursework at Duke University. 
...
Notes
- It is imperative to appreciate the data collection and coding methodologies laid out in [the ACLED code book](https://acleddata.com/knowledge-base/codebook/). See also specific methodology applied to the Ukraine conflict in the ACLED knowledge base [here](https://acleddata.com/knowledge-base/acled-methodology-and-coding-decisions-around-conflict-in-ukraine/). The linked article discusses decisions in attribution of events, grouping and disabiguating combatants as well as fatality reporting that may have bearing on downstream use of this aggregate dataset.
- 
- The nature of ACLED reporting and the hierarchy:
    - The “hierarchy” of reporting events, which seems more like an order of precdence to me, favors “battles” events over individual attacks or strikes. The latter can be masked by the former accordingly. “When an ‘Explosions/Remote violence’ event is reported in the context of an ongoing battle, it is merged and recorded as a single ‘Battles’ event”
...
- ACLED conflict events are reported at a daily resolution. Ongoing events are decomposed and spread over they days they affect. See https://acleddata.com/knowledge-base/codebook/#event-time

- ACLED sourcing - more information here: https://acleddata.com/knowledge-base/faqs-acled-sourcing-methodology/

NASA FIRMS
- VIIRS: 
    - Data usage and error characteristics are described thoroughly here: https://viirsland.gsfc.nasa.gov/PDF/VIIRS_activefire_User_Guide.pdf
- MODIS:
    - Usage and error characteristics are described here https://www.earthdata.nasa.gov/sites/default/files/imported/MODIS_C6_Fire_User_Guide_B.pdf
...
- The dataset is a subset of

-  A spatial join operation on ACLED reporting and NASA FIRMS data rejected any point geometry (locations) outside of the internationally recognized Ukraine borders. As a significant number of air, drone and artillery strikes occurred within Russian territory, expanding the analysis to include border provinves (oblasts?) would be warranted in future versions. 
...
## ❗️Preprocessing/cleaning/labeling
...
- We attribute reported conflict events to the smallest administrative division (Ukraianian hromada) associated, as atteseted to in the ACLED documentation: 
...
Note somewhere that I've removed the Ukrainian and Russian placenames in favor of the transliterated English name. These can be restored by ... 
